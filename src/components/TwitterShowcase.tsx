          ...
          <div className="flex items-center justify-center mb-4">
            ...
            <div className="flex space-x-2 ml-8">
              <Button
                ...
                size="sm"
                onClick={() => scroll('left')}
                className="w-10 h-10 p-0 border border-border bg-white text-foreground hover:bg-secondary"
                aria-label="上一页"
              >
        ...
        >
          <div className="flex gap-4 pb-4">
            {twitterEmbeds.map((embed) => (
              <div 
                key={embed.id} 
                className="flex-none w-80 bg-white border border-border rounded-lg p-4 shadow-sm"
